...
import { MapPin, Clock, Phone, Globe, ArrowLeft, XCircle } from "lucide-react";
...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  const library = await prisma.library.findUnique({ where: { id: Number(params.id) } });
  return {
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="grid lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2">
          ...
          <h1 className="text-2xl md:text-3xl font-bold text-warm-gray-700 mb-4">
            {library.name}
          </h1>
        ...
        <div>
          <Card hover={false}>
            <div className="p-5 space-y-4">
              <h2 className="font-bold text-warm-gray-700 border-b border-warm-gray-300/30 pb-3">
                도서관 정보
              </h2>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <a
                      ...
                      className="text-sm text-forest-700 hover:underline break-all"
                    >
                      {library.homepageUrl}
                    </a>
                  </div>
          ...
          <Card hover={false} className="mt-4">
            <div className="h-48 bg-warm-gray-100 rounded-xl flex items-center justify-center">
              <div className="text-center text-warm-gray-400">
                ...
                <p className="text-xs">(카카오맵 API 키 설정 후 표시)</p>
              </div>
            </div>
          </Card>
        </div>
